...
Whisperစာသားမှတ်တမ်းအတွက် ဘာသာစုံ Google Colabမှတ်စုစာအုပ်များ။

## အသွင်အပြင်

- **အသုံးပြုရန်အခမဲ့:** ဤမှတ်စုစာအုပ်တွင် OpenAIသည် OpenAIကို 2023 ခုနှစ် ဇန်န၀ါရီလ 17 ရက်နေ့တွင် အခမဲ့အရင်းအမြစ်အဖြစ် ဖန်တီးထားသည့် Google Colabနှင့် Google Colab၏ အခမဲ့ GPUruntime တို့နှင့်အတူ အသုံးပြုပါသည်။
- **ပုံသေမှတ်စုစာအုပ်ဘေး ဖိုင်အရွယ်အစားကန့်သတ်ချက်မရှိပါ။:** ကြီးမားသော အသံနှင့် ဗီဒီယိုဖိုင်များကို လုပ်ဆောင်နိုင်သည်။
- **အသုတ်လိုက်လုပ်ဆောင်ခြင်း။:** အသံနှင့် ဗီဒီယိုဖိုင်များစွာကို တစ်ကြိမ်တည်းတွင် လုပ်ဆောင်နိုင်သည်။
- **Google Driveပံ့ပိုးကူညီခြင်း။:** ဖိုင်များကို တိုက်ရိုက် အပ်လုဒ်လုပ်နိုင်ပြီး၊ သို့မဟုတ် Google Driveတွင် သိမ်းဆည်းထားသော အသံ/ဗီဒီယိုဖိုင်များကို စီမံဆောင်ရွက်နိုင်ပါသည်။
- **အပြည့်အဝအွန်လိုင်း:** ဒေါင်းလုဒ်များနှင့် လုပ်ဆောင်ခြင်းကို Google Colabတွင် လုပ်ဆောင်ပါသည်။ ဒေသတွင်း ကွန်ပျူတာအရင်းအမြစ်များကို အသုံးမပြုပါ။
- **အထွက်ဖော်မတ်များစွာ:** မှတ်စုစာအုပ်သည် မူရင်း JSONစာသားကို ထုတ်ပြီး TXT၊ CSV၊ Markdown၊ Excelနှင့် SRTစာတန်းထိုးဖိုင်များ ဆင်းသက်လာသည်။

## ဘာသာစကားများ

| ဘာသာစကား | README | မှတ်စုစာအုပ် |
| --- | --- | --- |
...
အမြစ် READMEသည် အင်္ဂလိပ် ဝင်ခွင့်အမှတ်ဖြစ်ပြီး docs/READMEသည် ဒေသန္တရပြုလုပ်ထားသော READMEဖိုင်များပါရှိသည်။ နမူနာမှတ်စုစာအုပ်သည် ရင်းမြစ်မှတ်စုစာအုပ်ဖြစ်ပြီး `{{cell1.title}}`ကဲ့သို့သော နေရာယူမှုများပါရှိသည်။ Locale ဖိုင်များသည် ဘာသာစကားအလိုက် READMEနှင့် Colab-facing မိတ္တူတို့ကို ပေးပါသည်။ ထုတ်လုပ်ထားသော မှတ်စုစာအုပ်များကို ကတိပြုထားသောကြောင့် Colab လင့်ခ်များသည် တည်ငြိမ်နေပါသည်။
...
CI အလုပ်အသွားအလာသည် READMEဖိုင်များနှင့် မှတ်စုစာအုပ်များကို ပုံစံပလိတ်နှင့် ဒေသဆိုင်ရာဖိုင်များမှ ပြန်လည်တည်ဆောက်ပေးသည်၊ မှတ်စုစာအုပ် JSONကိုစစ်ဆေးသည်၊ ဗလာကျင်းထားသော output များကိုစစ်ဆေးသည်၊ ကုဒ်ဆဲလ်များရှိ Python syntax ကိုစစ်ဆေးသည်၊ သိသာထင်ရှားသောမတော်တဆလျှို့ဝှက်ချက်များကိုစကန်ဖတ်ကာ၊ ထုတ်ပေးထားသောဖိုင်များကိုမကျူးလွန်သောအခါပျက်ကွက်သည်။

## CI က ဘာတွေ စမ်းသပ်နိုင်လဲ။

- ဒေသဖိုင်များမှ READMEမျိုးဆက်
- ပုံစံခွက်နှင့် ဒေသဖိုင်များမှ မှတ်စုစာအုပ် မျိုးဆက်
- မှတ်စုစာအုပ် JSONတရားဝင်မှု
- ကွပ်မျက်မှုအလွတ်များ
- ကုဒ်ဆဲလ်များရှိ Python အထားအသို
- ထင်ရှားသော မတော်တဆ လျှို့ဝှက်ချက်များ
- ထုတ်လုပ်လိုက်သော READMEနှင့် အရင်းအမြစ်များနှင့် ကိုက်ညီသော မှတ်စုစာအုပ်ဖိုင်များ

စာသားမှတ်တမ်း လမ်းကြောင်း အပြည့်အစုံသည် Colab-specific APIs၊ မော်ဒယ်ဒေါင်းလုဒ်များ၊ GPUရရှိနိုင်မှု၊ နှင့် သုံးစွဲသူမှပေးသော မီဒီယာဖိုင်များ လိုအပ်ပါသည်။ ထုတ်ပေးထားသော ဖိုင်စစ်ဆေးမှုများပြီးပါက ထိုလမ်းကြောင်းကို Manual Colab မီးခိုးစမ်းသပ်မှုအဖြစ် ခံယူပါ။

## လိုင်စင်

ဤသိုလှောင်မှု၏ READMEဂျင်နရေတာ၊ မှတ်စုစာအုပ် နမူနာပုံစံ၊ ဒေသဆိုင်ရာဖိုင်များ၊ ထုတ်လုပ်ထားသော မှတ်စုစာအုပ်များနှင့် ပြုပြင်ထိန်းသိမ်းမှုဆိုင်ရာ script များကို MITလိုင်စင်အောက်တွင် ထုတ်ဝေထားသည်။ Whisperမော်ဒယ်များနှင့် ပြင်ပအဖွဲ့အစည်း မှီခိုမှုများကို ၎င်းတို့၏ သက်ဆိုင်ရာလိုင်စင်များဖြင့် အုပ်ချုပ်သည်။
