...
Whisperтранскрипциясы үшін көптілді Google Colabжазу кітапшалары.
...
READMEтүбірі ағылшын тіліндегі енгізу нүктесі болып табылады және docs/READMEгенерацияланған локализацияланған READMEфайлдарын қамтиды. Үлгі жазу кітапшасы бастапқы жазу кітапшасы және `{{cell1.title}}`сияқты толтырғыштарды қамтиды. Жергілікті файлдар тілге тән READMEжәне Colab-қа қатысты көшірмені қамтамасыз етеді. Жасалған жазу кітапшалары Colab сілтемелері тұрақты болып қалуы үшін бекітілген.
...
CI жұмыс процесі READMEфайлдары мен жазу кітапшаларын үлгі мен тіл файлдарынан қайта құрады, жазу кітапшасын JSONтексереді, бос шығыстарды тексереді, код ұяшықтарындағы Python синтаксисін тексереді, анық кездейсоқ құпияларды сканерлейді және жасалған файлдар орындалмаған кезде сәтсіздікке ұшырайды.

## CI нені тексере алады

- Жергілікті файлдардан READMEқұру
- үлгі және тіл файлдарынан жазу кітапшасын құру
- ноутбук JSONжарамдылығы
- бос орындалу шығыстары
- Код ұяшықтарындағы Python синтаксисі
- анық кездейсоқ құпиялар
- жасалған READMEжәне дереккөздерге сәйкес жазу кітапшасы файлдары

Толық транскрипция жолы Colab-арнайы API интерфейстерін, жүктеп алу үлгілерін, GPUқолжетімділігін және пайдаланушы қамтамасыз ететін медиа файлдарды қажет етеді. Жасалған файлды тексеруден өткеннен кейін бұл жолды қолмен Colab түтін сынағы ретінде қарастырыңыз.

## Лицензия

Бұл репозиторийдің READMEгенераторы, жазу кітапшасының үлгісі, тіл файлдары, жасалған жазу кітапшалары және техникалық қызмет көрсету сценарийлері MITлицензиясы бойынша шығарылады. Whisperүлгілері және үшінші тарап тәуелділіктері олардың сәйкес лицензияларымен реттеледі.
