...
Whisperट्रान्सक्रिप्शनका लागि बहुभाषी Google Colabनोटबुकहरू।

## सुविधाहरू

- **प्रयोग गर्न नि: शुल्क:** यस नोटबुकले [openai/whisper](https://github.com/openai/whisper)प्रयोग गर्दछ, जुन OpenAIजनवरी १७, २०२३ मा खुला स्रोतमा Google Colabको नि:शुल्क GPUरनटाइमको साथमा।
- **कुनै निश्चित नोटबुक-साइड फाइल साइज सीमा छैन:** ठूला अडियो र भिडियो फाइलहरू प्रशोधन गर्न सकिन्छ।
- **ब्याच प्रशोधन:** धेरै अडियो र भिडियो फाइलहरू एक रन मा प्रशोधन गर्न सकिन्छ।
- **Google Driveसमर्थन:** फाइलहरू सीधा अपलोड गर्न सकिन्छ, वा Google Driveमा भण्डारण गरिएका अडियो/भिडियो फाइलहरू प्रशोधन गर्न सकिन्छ।
- **पूर्ण रूपमा अनलाइन:** डाउनलोड र प्रशोधन Google Colabमा प्रदर्शन गरिन्छ। स्थानीय कम्प्युटिङ स्रोतहरू प्रयोग गरिएको छैन।
- **बहु आउटपुट ढाँचाहरू:** नोटबुकले मूल JSONट्रान्सक्रिप्ट र व्युत्पन्न TXT, CSV, मार्कडाउन, Excel, र SRTउपशीर्षक फाइलहरू आउटपुट गर्दछ।
...
मूल READMEअंग्रेजी प्रविष्टि बिन्दु हो, र कागजात/READMEमा स्थानीयकृत READMEफाइलहरू समावेश छन्। टेम्प्लेट नोटबुक स्रोत नोटबुक हो र प्लेसहोल्डरहरू समावेश गर्दछ जस्तै `{{cell1.title}}`। स्थानीय फाइलहरूले भाषा-विशिष्ट READMEर Colab-फेसिङ प्रतिलिपि प्रदान गर्दछ। उत्पन्न गरिएका नोटबुकहरू प्रतिबद्ध छन् त्यसैले Colab लिङ्कहरू स्थिर रहन्छन्।
...
CI कार्यप्रवाहले टेम्प्लेट र लोकेल फाइलहरूबाट READMEफाइलहरू र नोटबुकहरू पुन: निर्माण गर्दछ, नोटबुक JSONजाँच गर्दछ, खाली आउटपुटहरू प्रमाणित गर्दछ, कोड कक्षहरूमा पाइथन सिन्ट्याक्स जाँच गर्दछ, स्पष्ट आकस्मिक रहस्यहरूको लागि स्क्यान गर्दछ, र उत्पन्न गरिएका फाइलहरू प्रतिबद्ध नभएमा असफल हुन्छ।

## CI ले के परीक्षण गर्न सक्छ

- READMEलोकेल फाइलहरूबाट जेनरेशन
- टेम्प्लेट र लोकेल फाइलहरूबाट नोटबुक उत्पादन
- नोटबुक JSONवैधता
- खाली निष्पादन आउटपुटहरू
- कोड कक्षहरूमा पाइथन सिन्ट्याक्स
- स्पष्ट आकस्मिक रहस्य
- प्रतिवद्ध उत्पन्न READMEर स्रोतहरूसँग मिल्ने नोटबुक फाइलहरू

पूर्ण ट्रान्सक्रिप्शन मार्गको लागि Colab-विशेष API, मोडेल डाउनलोडहरू, GPUउपलब्धता, र प्रयोगकर्ताले उपलब्ध गराएको मिडिया फाइलहरू चाहिन्छ। जेनेरेट गरिएको फाइल जाँच पास भएपछि उक्त मार्गलाई म्यानुअल Colab धुवाँ परीक्षणको रूपमा व्यवहार गर्नुहोस्।

## इजाजतपत्र

यस भण्डारको READMEजेनेरेटर, नोटबुक टेम्प्लेट, लोकेल फाइलहरू, उत्पन्न नोटबुकहरू, र मर्मत स्क्रिप्टहरू MITइजाजतपत्र अन्तर्गत जारी गरिएका छन्। Whisperमोडेलहरू र तेस्रो-पक्ष निर्भरताहरू तिनीहरूको सम्बन्धित इजाजतपत्रहरूद्वारा शासित हुन्छन्।
