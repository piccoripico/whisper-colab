...
Whisperप्रतिलेखन के लिए बहुभाषी Google Colabनोटबुक।

## विशेषताएं

- **उपयोग करने के लिए निःशुल्क:** This notebook uses [openai/whisper](https://github.com/openai/whisper), which OpenAIopen-sourced on January 17, 2023, together with Google Colab's free GPUruntime.
- **कोई निश्चित नोटबुक-साइड फ़ाइल आकार सीमा नहीं:** बड़ी ऑडियो और वीडियो फ़ाइलों को संसाधित किया जा सकता है।
- **Batch processing:** एकाधिक ऑडियो और वीडियो फ़ाइलों को एक बार में संसाधित किया जा सकता है।
- **Google Drivesupport:** Files can be uploaded directly, or audio/video files stored in Google Drivecan be processed.
- **पूरी तरह से ऑनलाइन:** Downloads and processing are performed on Google Colab. किसी भी स्थानीय कंप्यूटिंग संसाधन का उपयोग नहीं किया जाता है।
- **एकाधिक आउटपुट स्वरूप:** The notebook outputs the original JSONtranscript and derived TXT, CSV, Markdown, Excel, and SRTsubtitle files.

## भाषाएँ

| भाषा | README | स्मरण पुस्तक |
| --- | --- | --- |
...
रूट READMEअंग्रेजी प्रवेश बिंदु है, और docs/READMEमें स्थानीयकृत READMEफ़ाइलें शामिल हैं। टेम्प्लेट नोटबुक स्रोत नोटबुक है और इसमें `{{cell1.title}}`जैसे प्लेसहोल्डर शामिल हैं। लोकेल फ़ाइलें भाषा-विशिष्ट READMEऔर कोलाब-सामना वाली प्रतिलिपि प्रदान करती हैं। जेनरेटेड नोटबुक प्रतिबद्ध हैं ताकि कोलाब लिंक स्थिर रहें।
...
सीआई वर्कफ़्लो टेम्प्लेट और लोकेल फ़ाइलों से READMEफ़ाइलों और नोटबुक का पुनर्निर्माण करता है, नोटबुक JSONकी जाँच करता है, खाली आउटपुट की जाँच करता है, कोड कोशिकाओं में पायथन सिंटैक्स की जाँच करता है, स्पष्ट आकस्मिक रहस्यों के लिए स्कैन करता है, और जब उत्पन्न फ़ाइलें प्रतिबद्ध नहीं होती हैं तो विफल हो जाता है।

## सीआई क्या परीक्षण कर सकता है

- READMEलोकेल फ़ाइलों से पीढ़ी
- टेम्प्लेट और लोकेल फ़ाइलों से नोटबुक निर्माण
- नोटबुक JSONवैधता
- खाली निष्पादन आउटपुट
- कोड कोशिकाओं में पायथन सिंटैक्स
- स्पष्ट आकस्मिक रहस्य
- प्रतिबद्ध जेनरेटेड READMEऔर स्रोतों से मेल खाती नोटबुक फ़ाइलें

पूर्ण प्रतिलेखन पथ के लिए कोलाब-विशिष्ट एपीआई, मॉडल डाउनलोड, GPUउपलब्धता और उपयोगकर्ता द्वारा प्रदत्त मीडिया फ़ाइलों की आवश्यकता होती है। जनरेट की गई फ़ाइल जांच पास होने के बाद उस पथ को मैन्युअल कोलाब स्मोक परीक्षण के रूप में मानें।

## लाइसेंस

इस रिपॉजिटरी के READMEजनरेटर, नोटबुक टेम्पलेट, लोकेल फ़ाइलें, जेनरेट की गई नोटबुक और रखरखाव स्क्रिप्ट MITलाइसेंस के तहत जारी की जाती हैं। Whisperमॉडल और तृतीय-पक्ष निर्भरताएँ उनके संबंधित लाइसेंस द्वारा नियंत्रित होती हैं।
