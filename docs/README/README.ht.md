...
Kaye plizyè lang Google Colabou Whispertranskripsyon.

## Karakteristik

- **Gratis pou itilize:** Kaye sa a sèvi ak [openai/whisper](https://github.com/openai/whisper), ki OpenAIouvè sou 17 janvye 2023, ansanm ak Google Colabgratis GPU.
- **Pa gen limit gwosè dosye fiks kaye-bò:** Gwo dosye odyo ak videyo ka trete.
- **Pwosesis pakèt:** Plizyè dosye odyo ak videyo ka trete nan yon sèl kouri.
- **Google Drivesipò:** Fichye yo ka telechaje dirèkteman, oswa dosye odyo/videyo ki estoke nan Google Driveka trete.
- **Totalman sou entènèt:** Telechajman ak pwosesis yo fèt sou Google Colab. Yo pa itilize resous enfòmatik lokal yo.
- **Plizyè fòma pwodiksyon:** Kaye a bay transkripsyon orijinal JSONak dosye soutit TXT, CSV, Markdown, Excel, ak SRTki sòti.
...
Rasin READMEse pwen antre angle a, epi docs/READMEgen dosye lokalize READMEki te pwodwi yo. Kaye modèl la se kaye sous la epi li gen kote ki gen plas tankou `{{cell1.title}}`. Fichye lokal yo bay lang espesifik READMEak kopi ki fè fas a Colab. Kaye pwodwi yo angaje pou lyen Colab rete estab.
...
Flux travay CI a rebati fichye READMEak kaye ki soti nan fichye modèl yo ak lokal yo, tcheke kaye JSON, verifye rezilta vid yo, tcheke sentaks Python nan selil kòd yo, analize pou sekrè evidan aksidan, epi echwe lè yo pa komèt fichye pwodwi yo.

## Ki sa CI ka teste

- READMEjenerasyon ki soti nan dosye lokal yo
- jenerasyon kaye apati modèl ak dosye lokal yo
- kaye JSONvalidite
- rezilta ekzekisyon vid
- Sentaks Python nan selil kòd yo
- evidan sekrè aksidan
- komèt te pwodwi READMEak dosye kaye ki matche sous yo

Chemen transkripsyon konplè a mande pou API Colab espesifik, telechajman modèl, disponiblite GPU, ak dosye medya itilizatè yo bay yo. Trete chemen sa a kòm yon tès manyèl lafimen Colab apre chèk dosye ki te pwodwi yo pase.

## Lisans

Dèlko READMEdepo sa a, modèl kaye, dosye lokal yo, kaye pwodwi yo, ak script antretyen yo pibliye anba Lisans MIT. Modèl Whisperak depandans twazyèm pati yo gouvène pa lisans respektif yo.
