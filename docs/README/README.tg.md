...
Дафтарҳои бисёрзабонаи Google Colabбарои транскрипсияи Whisper.

## Хусусиятҳо

- **Истифодаи ройгон:** Ин ноутбук [openai/whisper](https://github.com/openai/whisper)-ро истифода мебарад, ки OpenAIдар 17 январи соли 2023 сарчашмаи кушода гирифта шудааст ва дар якҷоягӣ бо Google Colabвақти ройгони GPU.
- **Ягон маҳдудияти андозаи файли тарафи ноутбук:** Файлҳои аудио ва видеои калон метавонанд коркард карда шаванд.
- **Коркарди партия:** Якчанд файлҳои аудио ва видеоро дар як кор коркард кардан мумкин аст.
- **Google Driveдастгирӣ:** Файлҳоро мустақиман бор кардан мумкин аст ё файлҳои аудио/видео, ки дар Google Driveнигоҳ дошта мешаванд, коркард карда мешаванд.
- **Пурра онлайн:** Боргириҳо ва коркард дар Google Colabанҷом дода мешаванд. Ягон захираҳои ҳисоббарории маҳаллӣ истифода намешаванд.
- **Форматҳои бисёр баромад:** Ноутбук нусхаи аслии JSONва файлҳои субтитрҳои TXT, CSV, Markdown, Excelва SRTҳосилшударо мебарорад.

## Забонҳо

| Забон | README | Дафтарча |
| --- | --- | --- |
...
Реша READMEнуқтаи вуруди англисӣ аст ва docs/READMEдорои файлҳои маҳаллии READMEмебошад. Дафтарчаи қолабӣ дафтари манбаъ аст ва дорои ҷойнишинҳо ба монанди `{{cell1.title}}`. Файлҳои маҳаллӣ READMEба забони мушаххас ва нусхаи ба Colab нигаронидашударо таъмин мекунанд. Дафтарҳои тавлидшуда ӯҳдадор мешаванд, то истинодҳои Colab устувор бошанд.
...
Ҷараёни кории CI файлҳо ва ноутбукҳоро READMEаз қолаб ва файлҳои маҳаллӣ барқарор мекунад, дафтарчаи JSON-ро месанҷад, баромадҳои холиро месанҷад, синтаксиси Python-ро дар ҳуҷайраҳои код месанҷад, сирри тасодуфии ошкорро скан мекунад ва ҳангоми содир нашудани файлҳои тавлидшуда ноком мешавад.

## Чӣ CI метавонад озмоиш кунад

- READMEнасл аз файлҳои маҳаллӣ
- тавлиди дафтар аз қолаб ва файлҳои маҳаллӣ
- дафтар JSONэътибор
- натиҷаҳои иҷро холӣ
- Синтаксиси Python дар ҳуҷайраҳои код
- асрори тасодуфии ошкоро
- содиршуда тавлидшуда READMEва файлҳои дафтар мувофиқ ба манбаъҳо

Роҳи пурраи транскрипсия API-ҳои хоси Colab, зеркашиҳои модел, мавҷудияти GPUва файлҳои медиавӣ аз ҷониби корбарро талаб мекунад. Пас аз гузаштани санҷишҳои файлҳои тавлидшуда, ин роҳро ҳамчун озмоиши дастии дуди Colab баррасӣ кунед.

## Иҷозатнома

Генератори READMEин анбор, қолаби дафтар, файлҳои маҳаллӣ, ноутбукҳои тавлидшуда ва скриптҳои нигоҳдорӣ таҳти Литсензияи MITбароварда мешаванд. Whisperмоделҳо ва вобастагии тарафи сеюм аз рӯи иҷозатномаҳои мувофиқи онҳо идора карда мешаванд.
