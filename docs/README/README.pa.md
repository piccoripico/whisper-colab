...
Whisperਪ੍ਰਤੀਲਿਪੀ ਲਈ ਬਹੁ-ਭਾਸ਼ਾਈ Google Colabਨੋਟਬੁੱਕ।

## ਵਿਸ਼ੇਸ਼ਤਾਵਾਂ

- **ਵਰਤਣ ਲਈ ਮੁਫ਼ਤ:** ਇਹ ਨੋਟਬੁੱਕ [openai/whisper](https://github.com/openai/whisper)ਦੀ ਵਰਤੋਂ ਕਰਦੀ ਹੈ, ਜੋ OpenAI17 ਜਨਵਰੀ, 2023 ਨੂੰ ਓਪਨ ਸੋਰਸ, Google Colabਦੇ ਮੁਫਤ GPUਰਨਟਾਈਮ ਦੇ ਨਾਲ।
- **ਕੋਈ ਸਥਿਰ ਨੋਟਬੁੱਕ-ਸਾਈਡ ਫਾਈਲ ਆਕਾਰ ਸੀਮਾ ਨਹੀਂ ਹੈ:** ਵੱਡੀਆਂ ਆਡੀਓ ਅਤੇ ਵੀਡੀਓ ਫਾਈਲਾਂ 'ਤੇ ਕਾਰਵਾਈ ਕੀਤੀ ਜਾ ਸਕਦੀ ਹੈ।
- **ਬੈਚ ਪ੍ਰੋਸੈਸਿੰਗ:** ਕਈ ਆਡੀਓ ਅਤੇ ਵੀਡੀਓ ਫਾਈਲਾਂ ਨੂੰ ਇੱਕ ਰਨ ਵਿੱਚ ਪ੍ਰੋਸੈਸ ਕੀਤਾ ਜਾ ਸਕਦਾ ਹੈ।
- **Google Driveਸਮਰਥਨ:** ਫਾਈਲਾਂ ਨੂੰ ਸਿੱਧੇ ਅਪਲੋਡ ਕੀਤਾ ਜਾ ਸਕਦਾ ਹੈ, ਜਾਂ Google Driveਵਿੱਚ ਸਟੋਰ ਕੀਤੀਆਂ ਆਡੀਓ/ਵੀਡੀਓ ਫਾਈਲਾਂ ਤੇ ਕਾਰਵਾਈ ਕੀਤੀ ਜਾ ਸਕਦੀ ਹੈ।
- **ਪੂਰੀ ਤਰ੍ਹਾਂ ਆਨਲਾਈਨ:** ਡਾਊਨਲੋਡ ਅਤੇ ਪ੍ਰੋਸੈਸਿੰਗ Google Colab'ਤੇ ਕੀਤੀ ਜਾਂਦੀ ਹੈ। ਕੋਈ ਸਥਾਨਕ ਕੰਪਿਊਟਿੰਗ ਸਰੋਤ ਨਹੀਂ ਵਰਤੇ ਜਾਂਦੇ ਹਨ।
- **ਮਲਟੀਪਲ ਆਉਟਪੁੱਟ ਫਾਰਮੈਟ:** ਨੋਟਬੁੱਕ ਮੂਲ JSONਪ੍ਰਤੀਲਿਪੀ ਅਤੇ TXT, CSV, ਮਾਰਕਡਾਊਨ, Excel, ਅਤੇ SRTਉਪਸਿਰਲੇਖ ਫਾਈਲਾਂ ਨੂੰ ਆਊਟਪੁੱਟ ਕਰਦੀ ਹੈ।

## ਭਾਸ਼ਾਵਾਂ

| ਭਾਸ਼ਾ | README | ਨੋਟਬੁੱਕ |
| --- | --- | --- |
...
ਰੂਟ READMEਅੰਗਰੇਜ਼ੀ ਐਂਟਰੀ ਪੁਆਇੰਟ ਹੈ, ਅਤੇ docs/READMEਵਿੱਚ ਜਨਰੇਟ ਕੀਤੀਆਂ READMEਫਾਈਲਾਂ ਹਨ। ਟੈਂਪਲੇਟ ਨੋਟਬੁੱਕ ਸਰੋਤ ਨੋਟਬੁੱਕ ਹੈ ਅਤੇ ਇਸ ਵਿੱਚ `{{cell1.title}}`ਵਰਗੇ ਪਲੇਸਹੋਲਡਰ ਸ਼ਾਮਲ ਹਨ। ਲੋਕੇਲ ਫਾਈਲਾਂ ਭਾਸ਼ਾ-ਵਿਸ਼ੇਸ਼ READMEਅਤੇ ਕੋਲੈਬ-ਸਾਹਮਣਾ ਵਾਲੀ ਕਾਪੀ ਪ੍ਰਦਾਨ ਕਰਦੀਆਂ ਹਨ। ਜਨਰੇਟ ਕੀਤੀਆਂ ਨੋਟਬੁੱਕਾਂ ਪ੍ਰਤੀਬੱਧ ਹਨ ਤਾਂ ਕਿ ਕੋਲੈਬ ਲਿੰਕ ਸਥਿਰ ਰਹਿਣ।
...
CI ਵਰਕਫਲੋ ਟੈਂਪਲੇਟ ਅਤੇ ਲੋਕੇਲ ਫਾਈਲਾਂ ਤੋਂ READMEਫਾਈਲਾਂ ਅਤੇ ਨੋਟਬੁੱਕਾਂ ਨੂੰ ਦੁਬਾਰਾ ਬਣਾਉਂਦਾ ਹੈ, ਨੋਟਬੁੱਕ JSONਦੀ ਜਾਂਚ ਕਰਦਾ ਹੈ, ਖਾਲੀ ਆਉਟਪੁੱਟਾਂ ਦੀ ਪੁਸ਼ਟੀ ਕਰਦਾ ਹੈ, ਕੋਡ ਸੈੱਲਾਂ ਵਿੱਚ ਪਾਈਥਨ ਸੰਟੈਕਸ ਦੀ ਜਾਂਚ ਕਰਦਾ ਹੈ, ਸਪੱਸ਼ਟ ਦੁਰਘਟਨਾ ਦੇ ਭੇਦ ਲਈ ਸਕੈਨ ਕਰਦਾ ਹੈ, ਅਤੇ ਜਦੋਂ ਫਾਈਲਾਂ ਤਿਆਰ ਨਹੀਂ ਕੀਤੀਆਂ ਜਾਂਦੀਆਂ ਹਨ ਤਾਂ ਅਸਫਲ ਹੋ ਜਾਂਦੀ ਹੈ।

## CI ਕੀ ਟੈਸਟ ਕਰ ਸਕਦਾ ਹੈ

- READMEਲੋਕੇਲ ਫਾਈਲਾਂ ਤੋਂ ਪੀੜ੍ਹੀ
- ਟੈਂਪਲੇਟ ਅਤੇ ਲੋਕੇਲ ਫਾਈਲਾਂ ਤੋਂ ਨੋਟਬੁੱਕ ਬਣਾਉਣਾ
- ਨੋਟਬੁੱਕ JSONਵੈਧਤਾ
- ਖਾਲੀ ਐਗਜ਼ੀਕਿਊਸ਼ਨ ਆਉਟਪੁੱਟ
- ਕੋਡ ਸੈੱਲਾਂ ਵਿੱਚ ਪਾਈਥਨ ਸੰਟੈਕਸ
- ਸਪੱਸ਼ਟ ਦੁਰਘਟਨਾ ਭੇਦ
- ਵਚਨਬੱਧ READMEਅਤੇ ਨੋਟਬੁੱਕ ਫਾਈਲਾਂ ਸਰੋਤਾਂ ਨਾਲ ਮੇਲ ਖਾਂਦੀਆਂ ਹਨ

ਪੂਰੇ ਟ੍ਰਾਂਸਕ੍ਰਿਪਸ਼ਨ ਮਾਰਗ ਲਈ ਕੋਲੈਬ-ਵਿਸ਼ੇਸ਼ API, ਮਾਡਲ ਡਾਊਨਲੋਡ, GPUਉਪਲਬਧਤਾ, ਅਤੇ ਉਪਭੋਗਤਾ ਦੁਆਰਾ ਪ੍ਰਦਾਨ ਕੀਤੀਆਂ ਮੀਡੀਆ ਫ਼ਾਈਲਾਂ ਦੀ ਲੋੜ ਹੁੰਦੀ ਹੈ। ਜਨਰੇਟ-ਫਾਈਲ ਜਾਂਚਾਂ ਪਾਸ ਹੋਣ ਤੋਂ ਬਾਅਦ ਉਸ ਮਾਰਗ ਨੂੰ ਮੈਨੂਅਲ ਕੋਲੈਬ ਸਮੋਕ ਟੈਸਟ ਦੇ ਰੂਪ ਵਿੱਚ ਵਰਤੋ।

## ਲਾਇਸੰਸ

ਇਸ ਰਿਪੋਜ਼ਟਰੀ ਦਾ READMEਜਨਰੇਟਰ, ਨੋਟਬੁੱਕ ਟੈਂਪਲੇਟ, ਲੋਕੇਲ ਫਾਈਲਾਂ, ਤਿਆਰ ਕੀਤੀਆਂ ਨੋਟਬੁੱਕਾਂ, ਅਤੇ ਰੱਖ-ਰਖਾਅ ਸਕ੍ਰਿਪਟਾਂ MITਲਾਇਸੈਂਸ ਦੇ ਅਧੀਨ ਜਾਰੀ ਕੀਤੀਆਂ ਗਈਆਂ ਹਨ। Whisperਮਾਡਲ ਅਤੇ ਥਰਡ-ਪਾਰਟੀ ਨਿਰਭਰਤਾ ਉਹਨਾਂ ਦੇ ਸੰਬੰਧਿਤ ਲਾਇਸੰਸ ਦੁਆਰਾ ਨਿਯੰਤਰਿਤ ਕੀਤੀ ਜਾਂਦੀ ਹੈ।
