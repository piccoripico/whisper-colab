...
Многоезични Google Colabтетрадки за Whisperтранскрипция.

## Характеристики

- **Безплатен за използване:** Този бележник използва [openai/whisper](https://github.com/openai/whisper), който OpenAI отвори с отворен код на 17 януари 2023 г., заедно с безплатното време за изпълнение на GPU на Google Colab.
- **Няма фиксирано ограничение за размера на файла от страната на преносимия компютър:** Могат да се обработват големи аудио и видео файлове.
- **Пакетна обработка:** Множество аудио и видео файлове могат да бъдат обработени наведнъж.
- **Поддръжка на Google Drive:** Файловете могат да се качват директно или могат да се обработват аудио/видео файлове, съхранявани в Google Drive.
- **Изцяло онлайн:** Изтеглянията и обработката се извършват в Google Colab. Не се използват локални изчислителни ресурси.
- **Множество изходни формати:** Бележникът извежда оригиналния JSON препис и извлечените TXT, CSV, Markdown, Excel и SRT файлове със субтитри.

## Езици

| език | README | Бележник |
| --- | --- | --- |
...
Коренът READMEе английската входна точка, а docs/READMEсъдържа генерирани локализирани READMEфайлове. Шаблонният бележник е изходният бележник и съдържа контейнери като `{{cell1.title}}`. Файловете за локализиране предоставят специфично за езика READMEи копие с лице към Colab. Генерираните бележници са ангажирани, така че връзките на Colab остават стабилни.
...
Работният поток на CI възстановява READMEфайлове и бележници от файловете на шаблона и локала, проверява бележника JSON, проверява празните изходи, проверява синтаксиса на Python в кодовите клетки, сканира за очевидни случайни тайни и се проваля, когато генерираните файлове не са ангажирани.

## Какво CI може да тества

- READMEгенериране от локални файлове
- генериране на бележник от файловете на шаблона и локала
- тетрадка JSONвалидност
- празни изходи за изпълнение
- Синтаксис на Python в кодови клетки
- очевидни случайни тайни
- ангажирани генерирани READMEи файлове на бележник, съответстващи на източниците

Пълният път на транскрипция изисква специфични за Colab API, изтегляния на модели, GPUналичност и медийни файлове, предоставени от потребителя. Третирайте този път като ръчен димен тест на Colab, след като проверките на генерирания файл преминат.

## Лиценз

Генераторът READMEна това хранилище, шаблонът за бележник, локалните файлове, генерираните бележници и скриптовете за поддръжка са пуснати под лиценза MIT. Whisperмоделите и зависимостите от трети страни се управляват от съответните им лицензи.
