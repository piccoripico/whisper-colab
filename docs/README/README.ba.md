...
Транскрипция өсөн күп телле Google Colabдәфтәрҙәре.

## Сифаттар

- **Бушлай ҡулланыу:** Был ноутбукта [openai/whisper](https://github.com/openai/whisper)ҡулланыла, ул OpenAI2023 йылдың 17 ғинуарында асыҡ сығанаҡлы, Google Colab-ның бушлай GPUэшләү ваҡыты менән бергә.
- **Дәфтәр яғында файл күләменең нығытылған сиге юҡ:** Ҙур аудио һәм видео файлдарҙы эшкәртергә мөмкин.
- **Партиялы эшкәртеү:** Бер йүгереүҙән бер нисә аудио һәм видеофайлды эшкәртергә мөмкин.
- **Google Drive support:** Файлдарҙы туранан-тура тейәп була, йәки Google Driveһаҡланған аудио/видео файлдарҙы эшкәртергә мөмкин.
- **Тулыһынса онлайн:** Скачивание һәм эшкәртелеү Google Colabадресы буйынса башҡарыла. Урындағы иҫәпләү ресурстары ҡулланылмай.
- **Бер нисә сығыу форматы:** Дәфтәрҙә төп стенограмма һәм алынған TXT, CSV, Markdown, Excelһәм SRTсубтитрҙар файлдары сығарыла.
...
READMEтамыры инглиз теленең инеү нөктәһе булып тора, ә docs/READMEгенерацияланған локалләштерелгән READMEфайлдарын үҙ эсенә ала. Ҡалып дәфтәре сығанаҡ дәфтәре булып тора һәм `{{cell1.title}}`кеүек урын билдәләүселәрҙе үҙ эсенә ала. Локаль файлдар телгә хас READMEһәм Colab-ҡа ҡараған күсермәһен тәьмин итә. Генерацияланған ноутбуктар йөкмәтелгән, шуға күрә Colab һылтанмалар тотороҡло ҡала.
...
CI эш ағымы READMEфайлдарын һәм дәфтәрҙәрҙе шаблон һәм локаль файлдарҙан яңынан төҙөй, JSONдәфтәрен тикшерә, буш сығыштарҙы тикшерә, код күҙәнәктәрендә Python синтаксисын тикшерә, асыҡ осраҡлы серҙәрҙе тикшерә һәм генерацияланған файлдар булмағанда уңышһыҙлыҡҡа осрай.

## Ниндәй CI һынай ала

- READMEлокаль файлдарҙан быуын
- шаблон һәм локаль файлдарҙан ноутбук генерациялау
- notebook JSON validity
- буш башҡарыу һөҙөмтәләре
- Код күҙәнәктәрендә Python синтаксисы
- асыҡ осраҡлы серҙәр
- йөкмәтелгән генерацияланған READMEһәм сығанаҡтарға тап килгән ноутбук файлдары

Тулы транскрипция юлы өсөн Colab-ҡа махсус API-лар, модель скачиваниелары, GPUдоступность һәм ҡулланыусылар биргән медиа-файлдар талап ителә. Ҡул менән ҡабул итеү, тип юл Colab төтөн һынау генерацияланған-файл тикшергәндән һуң үткән.

## Лицензия

Был һаҡлағыстың READMEгенераторы, ноутбук ҡалыбы, локаль файлдар, генерацияланған ноутбуктар һәм хеҙмәтләндереүҙең сценарийҙары MITлицензияһы буйынса сығарыла. Whisperмоделдәре һәм өсөнсө яҡтан бәйлелектәр үҙҙәренең тейешле лицензиялары менән идара ителә.
