...
ປື້ມບັນທຶກຫຼາຍພາສາ Google Colabສຳລັບການຖອດຂໍ້ຄວາມຈາກສຽງ Whisper.

## ຄຸນສົມບັດ

- **ໃຊ້ຟຣີ:** ປື້ມບັນທຶກນີ້ໃຊ້ [openai/whisper](https://github.com/openai/whisper), ເຊິ່ງ OpenAIopen-sourced ໃນວັນທີ 17 ມັງກອນ 2023, ຮ່ວມກັບ Google Colab's free runtime GPU.
- **ບໍ່ມີກໍານົດຂອບເຂດຂະຫນາດໄຟລ໌ຂ້າງປື້ມບັນທຶກຄົງທີ່:** ໄຟລ໌ສຽງແລະວິດີໂອຂະຫນາດໃຫຍ່ສາມາດໄດ້ຮັບການປະມວນຜົນ.
- **ການປະມວນຜົນ batch:** ໄຟລ໌ສຽງ ແລະວິດີໂອຫຼາຍອັນສາມາດປະມວນຜົນໄດ້ໃນຄັ້ງດຽວ.
- **Google Driveສະຫນັບສະຫນູນ:** ໄຟລ໌ສາມາດຖືກອັບໂຫລດໂດຍກົງ, ຫຼືໄຟລ໌ສຽງ/ວິດີໂອທີ່ເກັບໄວ້ໃນ Google Driveສາມາດປະມວນຜົນໄດ້.
- **ເຕັມອອນໄລນ໌:** ການດາວໂຫຼດແລະການປະມວນຜົນແມ່ນດໍາເນີນຢູ່ Google Colab. ບໍ່ມີຊັບພະຍາກອນຄອມພິວເຕີໃນທ້ອງຖິ່ນຖືກນໍາໃຊ້.
- **ຮູບແບບຜົນຜະລິດຫຼາຍ:** ປື້ມບັນທຶກດັ່ງກ່າວໃຫ້ຂໍ້ມູນຕົ້ນສະບັບ JSONແລະໄດ້ມາຈາກ TXT, CSV, Markdown, Excel, ແລະ SRTໄຟລ໌ຄໍາບັນຍາຍ.

## ພາສາ

| ພາສາ | README | ປື້ມບັນທຶກ |
| --- | --- | --- |
...
ຮາກ READMEແມ່ນຈຸດເຂົ້າພາສາອັງກິດ, ແລະ docs/READMEມີໄຟລ໌ READMEທີ່ສ້າງຂຶ້ນ. ປື້ມບັນທຶກແມ່ແບບແມ່ນປື້ມບັນທຶກທີ່ມາ ແລະປະກອບດ້ວຍຕົວຍຶດບ່ອນເຊັ່ນ `{{cell1.title}}`. ໄຟລ໌ທ້ອງຖິ່ນສະໜອງພາສາສະເພາະ READMEແລະສຳເນົາແບບ Colab. ປື້ມບັນທຶກທີ່ສ້າງຂຶ້ນແມ່ນມີຄວາມຕັ້ງໃຈເພື່ອໃຫ້ການເຊື່ອມຕໍ່ Colab ຄົງທີ່.
...
ຂັ້ນຕອນການເຮັດວຽກ CI ກໍ່ສ້າງໄຟລ໌ READMEແລະປື້ມບັນທຶກຈາກແມ່ແບບ ແລະໄຟລ໌ທ້ອງຖິ່ນ, ກວດສອບໂນ໊ດບຸ໊ກ JSON, ກວດສອບຜົນໄດ້ຮັບທີ່ຫວ່າງເປົ່າ, ກວດສອບ syntax Python ໃນເຊລລະຫັດ, ສະແກນຫາຄວາມລັບໂດຍບັງເອີນທີ່ເຫັນໄດ້ຊັດ, ແລະລົ້ມເຫລວເມື່ອໄຟລ໌ທີ່ສ້າງຂຶ້ນບໍ່ໄດ້ຕັ້ງໃຈ.

## ສິ່ງທີ່ CI ສາມາດທົດສອບໄດ້

- READMEການຜະລິດຈາກໄຟລ໌ທ້ອງຖິ່ນ
- ການສ້າງປື້ມບັນທຶກຈາກແມ່ແບບ ແລະໄຟລ໌ທ້ອງຖິ່ນ
- ປື້ມບັນທຶກ JSONຖືກຕ້ອງ
- ຜົນໄດ້ຮັບການປະຕິບັດເປົ່າ
- syntax Python ໃນຕາລາງລະຫັດ
- ຄວາມລັບຂອງອຸບັດຕິເຫດທີ່ຈະແຈ້ງ
- ຄໍາຫມັ້ນສັນຍາທີ່ສ້າງ READMEແລະໄຟລ໌ປື້ມບັນທຶກທີ່ກົງກັບແຫຼ່ງ

ເສັ້ນທາງການຖອດຂໍ້ຄວາມເຕັມຕ້ອງການ APIs ສະເພາະຂອງ Colab, ການດາວໂຫຼດແບບຈໍາລອງ, ການມີຢູ່ GPUແລະໄຟລ໌ສື່ທີ່ຜູ້ໃຊ້ສະໜອງໃຫ້. ຮັກສາເສັ້ນທາງນັ້ນເປັນການທົດສອບຄວັນໄຟຂອງ Colab ດ້ວຍຕົນເອງຫຼັງຈາກການກວດສອບໄຟລ໌ທີ່ສ້າງແລ້ວຜ່ານໄປ.

## ໃບອະນຸຍາດ

ເຄື່ອງສ້າງ READMEຂອງບ່ອນເກັບມ້ຽນ, ແມ່ແບບປື້ມບັນທຶກ, ໄຟລ໌ທ້ອງຖິ່ນ, ປື້ມບັນທຶກທີ່ສ້າງຂຶ້ນ, ແລະສະຄຣິບບຳລຸງຮັກສາຖືກປ່ອຍອອກມາພາຍໃຕ້ໃບອະນຸຍາດ MIT. ແບບຈໍາລອງ Whisperແລະການຂຶ້ນກັບພາກສ່ວນທີສາມແມ່ນຄຸ້ມຄອງໂດຍໃບອະນຸຍາດທີ່ກ່ຽວຂ້ອງ.
