...
ባለብዙ ቋንቋ Google Colabማስታወሻ ደብተሮች ለ Whisperግልባጭ።

## ባህሪያት

- **ለመጠቀም ነፃ:** ይህ ማስታወሻ ደብተር [openai/whisper](https://github.com/openai/whisper)ይጠቀማል፣ እሱም OpenAIበጃንዋሪ 17፣ 2023 ክፍት ምንጭ ከGoogle Colabነጻ GPUየአሂድ ጊዜ ጋር።
- **ቋሚ ማስታወሻ ደብተር የጎን ፋይል መጠን ገደብ የለም።:** ትላልቅ የድምጽ እና የቪዲዮ ፋይሎች ሊሰሩ ይችላሉ.
- **ባች ማቀነባበሪያ:** በርካታ የኦዲዮ እና የቪዲዮ ፋይሎች በአንድ ሩጫ ሊሰሩ ይችላሉ።
- **Google Driveድጋፍ:** ፋይሎች በቀጥታ ሊሰቀሉ ይችላሉ ወይም በ Google Driveውስጥ የተከማቹ የኦዲዮ/ቪዲዮ ፋይሎች ሊሠሩ ይችላሉ።
- **ሙሉ በሙሉ በመስመር ላይ:** ማውረዶች እና ሂደቶች የሚከናወኑት በ Google Colabላይ ነው። ምንም የአገር ውስጥ የማስላት ግብዓቶች ጥቅም ላይ አይውሉም።
- **በርካታ የውጤት ቅርጸቶች:** ማስታወሻ ደብተሩ የመጀመሪያውን JSONግልባጭ ያወጣል እና TXT፣ CSV፣ Markdown፣ Excelእና SRTየትርጉም ፋይሎችን ያወጣል።

## ቋንቋዎች

| ቋንቋ | README | ማስታወሻ ደብተር |
| --- | --- | --- |
...
ስር READMEየእንግሊዝኛ መግቢያ ነጥብ ነው፣ እና ሰነዶች/READMEየተተረጎሙ READMEፋይሎችን ይዟል። የአብነት ማስታወሻ ደብተር የምንጭ ማስታወሻ ደብተር ሲሆን እንደ `{{cell1.title}}`ያሉ ቦታ ያዥዎችን ይዟል። የአካባቢ ፋይሎች ቋንቋ-ተኮር READMEእና ኮላብ የሚመለከት ቅጂ ይሰጣሉ። የኮላብ ማያያዣዎች ተረጋግተው እንዲቆዩ የተፈጠሩ ማስታወሻ ደብተሮች ቁርጠኞች ናቸው።
...
የCI የስራ ፍሰቱ READMEፋይሎችን እና ማስታወሻ ደብተሮችን ከአብነት እና ከአካባቢያዊ ፋይሎች እንደገና ይገነባል፣ ማስታወሻ ደብተር JSONን ይፈትሻል፣ ባዶ ውጤቶችን ያረጋግጣል፣ የፓይዘን አገባብ በኮድ ሴሎች ውስጥ ይፈትሻል፣ ግልጽ የአደጋ ሚስጥሮችን ይፈትሻል፣ እና የተፈጠሩ ፋይሎች ሳይፈጸሙ ሲቀሩ አይሳካም።

## CI ምን መሞከር ይችላል

- READMEትውልድ ከአካባቢያዊ ፋይሎች
- ከአብነት እና ከአካባቢያዊ ፋይሎች የማስታወሻ ደብተር ማመንጨት
- ማስታወሻ ደብተር JSONትክክለኛነት
- ባዶ የማስፈጸሚያ ውጤቶች
- በኮድ ሴሎች ውስጥ የፓይዘን አገባብ
- ግልጽ የአጋጣሚ ሚስጥሮች
- የመነጨ READMEእና ምንጮቹን የሚዛመዱ የማስታወሻ ደብተር ፋይሎች

ሙሉው የጽሑፍ ግልባጭ ዱካ ኮላብ-ተኮር ኤፒአይዎችን፣ የሞዴል ማውረዶችን፣ GPUመገኘትን እና በተጠቃሚ የቀረቡ የሚዲያ ፋይሎችን ይፈልጋል። የፋይል ፍተሻ ካለፉ በኋላ ያንን መንገድ እንደ በእጅ የሚሰራ የኮላብ ጭስ ሙከራ አድርገው ይያዙት።

## ፍቃድ

የዚህ ማከማቻ READMEጀነሬተር፣ የማስታወሻ ደብተር አብነት፣ የአካባቢ ፋይሎች፣ የተፈጠሩ ማስታወሻ ደብተሮች እና የጥገና ስክሪፕቶች በMITፍቃድ ስር ተለቅቀዋል። Whisperሞዴሎች እና የሶስተኛ ወገን ጥገኞች በየራሳቸው ፍቃድ ነው የሚተዳደሩት።
