...
Whisperట్రాన్స్‌క్రిప్షన్ కోసం బహుభాషా Google Colabనోట్‌బుక్‌లు.

## ఫీచర్లు

- **ఉపయోగించడానికి ఉచితం:** ఈ నోట్‌బుక్ [openai/whisper](https://github.com/openai/whisper)ని ఉపయోగిస్తుంది, ఇది OpenAIజనవరి 17, 2023న ఓపెన్ సోర్స్ చేయబడింది, అలాగే Google Colabయొక్క ఉచిత GPUరన్‌టైమ్.
- **స్థిరమైన నోట్‌బుక్ వైపు ఫైల్ పరిమాణ పరిమితి లేదు:** పెద్ద ఆడియో మరియు వీడియో ఫైల్‌లను ప్రాసెస్ చేయవచ్చు.
- **బ్యాచ్ ప్రాసెసింగ్:** బహుళ ఆడియో మరియు వీడియో ఫైల్‌లను ఒకే రన్‌లో ప్రాసెస్ చేయవచ్చు.
- **Google Driveమద్దతు:** ఫైల్‌లను నేరుగా అప్‌లోడ్ చేయవచ్చు లేదా Google Driveలో నిల్వ చేయబడిన ఆడియో/వీడియో ఫైల్‌లను ప్రాసెస్ చేయవచ్చు.
- **పూర్తిగా ఆన్‌లైన్:** డౌన్‌లోడ్‌లు మరియు ప్రాసెసింగ్ Google Colabలో నిర్వహించబడతాయి. స్థానిక కంప్యూటింగ్ వనరులు ఉపయోగించబడవు.
- **బహుళ అవుట్‌పుట్ ఫార్మాట్‌లు:** నోట్‌బుక్ అసలైన JSONట్రాన్‌స్క్రిప్ట్‌ను అవుట్‌పుట్ చేస్తుంది మరియు TXT, CSV, మార్క్‌డౌన్, Excelమరియు SRTఉపశీర్షిక ఫైల్‌లను పొందింది.
...
READMEఅనే మూలం ఇంగ్లీష్ ఎంట్రీ పాయింట్ మరియు డాక్స్/READMEఅనేది స్థానికీకరించిన READMEఫైల్‌లను కలిగి ఉంటుంది. టెంప్లేట్ నోట్‌బుక్ సోర్స్ నోట్‌బుక్ మరియు `{{cell1.title}}`వంటి ప్లేస్‌హోల్డర్‌లను కలిగి ఉంటుంది. లొకేల్ ఫైల్‌లు భాష-నిర్దిష్ట READMEమరియు కోలాబ్-ఫేసింగ్ కాపీని అందిస్తాయి. రూపొందించిన నోట్‌బుక్‌లు కట్టుబడి ఉంటాయి కాబట్టి Colab లింక్‌లు స్థిరంగా ఉంటాయి.
...
CI వర్క్‌ఫ్లో టెంప్లేట్ మరియు లొకేల్ ఫైల్‌ల నుండి READMEఫైల్‌లు మరియు నోట్‌బుక్‌లను పునర్నిర్మిస్తుంది, నోట్‌బుక్ JSONని తనిఖీ చేస్తుంది, ఖాళీ అవుట్‌పుట్‌లను ధృవీకరిస్తుంది, కోడ్ సెల్‌లలో పైథాన్ సింటాక్స్‌ను తనిఖీ చేస్తుంది, స్పష్టమైన ప్రమాదవశాత్తు రహస్యాల కోసం స్కాన్ చేస్తుంది మరియు రూపొందించబడిన ఫైల్‌లు కమిట్ కానప్పుడు విఫలమవుతుంది.

## CI ఏమి పరీక్షించగలదు

- లొకేల్ ఫైల్‌ల నుండి READMEజనరేషన్
- టెంప్లేట్ మరియు లొకేల్ ఫైల్‌ల నుండి నోట్‌బుక్ ఉత్పత్తి
- నోట్‌బుక్ JSONచెల్లుబాటు
- ఖాళీ అమలు అవుట్‌పుట్‌లు
- కోడ్ సెల్‌లలో పైథాన్ సింటాక్స్
- స్పష్టమైన ప్రమాద రహస్యాలు
- READMEమరియు మూలాధారాలకు సరిపోలే నోట్‌బుక్ ఫైల్‌లు రూపొందించబడ్డాయి

పూర్తి లిప్యంతరీకరణ మార్గానికి Colab-నిర్దిష్ట APIలు, మోడల్ డౌన్‌లోడ్‌లు, GPUలభ్యత మరియు వినియోగదారు అందించిన మీడియా ఫైల్‌లు అవసరం. రూపొందించిన-ఫైల్ తనిఖీలు పాస్ అయిన తర్వాత ఆ మార్గాన్ని మాన్యువల్ Colab పొగ పరీక్షగా పరిగణించండి.

## లైసెన్స్

ఈ రిపోజిటరీ యొక్క READMEజెనరేటర్, నోట్‌బుక్ టెంప్లేట్, లొకేల్ ఫైల్‌లు, రూపొందించిన నోట్‌బుక్‌లు మరియు నిర్వహణ స్క్రిప్ట్‌లు MITలైసెన్స్ క్రింద విడుదల చేయబడతాయి. Whisperమోడల్‌లు మరియు థర్డ్-పార్టీ డిపెండెన్సీలు వాటి సంబంధిత లైసెన్స్‌లచే నిర్వహించబడతాయి.
