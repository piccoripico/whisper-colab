...
Multilingual Google Colabiwe ajako fun Whispertranscription.

## Awọn ẹya ara ẹrọ

- **Ọfẹ lati lo:** Iwe ajako yii nlo [openai/whisper](https://github.com/openai/whisper), eyiti OpenAIṣiṣi-orisun ni Oṣu Kini Ọjọ 17, Ọdun 2023, papọ pẹlu Google Colab's ọfẹ GPUasiko ṣiṣe.
- **Ko si opin iwọn faili ẹgbẹ ajako ti o wa titi:** Nla iwe ohun ati awọn faili fidio le wa ni ilọsiwaju.
- **Sise ipele:** Ọpọ iwe ohun ati awọn faili fidio le wa ni ilọsiwaju ni ọkan run.
- **Google Drivesupport:** Awọn faili le ṣe ikojọpọ taara, tabi awọn faili ohun/fidio ti a fipamọ sinu Google Driveni a le ṣe ilana.
- **Ni kikun lori ayelujara:** Awọn igbasilẹ ati ṣiṣe ni a ṣe lori Google Colab. Ko si awọn orisun iširo agbegbe ti a lo.
- **Awọn ọna kika ti o pọju:** Iwe ajako naa ṣe agbejade atilẹba JSONtranscript ati jijade TXT, CSV, Markdown, Excel, ati SRTawọn faili atunkọ.

## Awọn ede

| Ede | README | Iwe akiyesi |
| --- | --- | --- |
...
Gbongbo READMEni aaye titẹsi Gẹẹsi, ati pe awọn docs/READMEni ti ipilẹṣẹ READMEawọn faili ti agbegbe. Iwe ajako awoṣe jẹ iwe afọwọkọ orisun ati pe o ni awọn oniduro bii `{{cell1.title}}`. Awọn faili agbegbe pese ede-pato READMEati ẹda ti nkọju si Colab. Awọn iwe ajako ti ipilẹṣẹ jẹ ifaramọ nitorina awọn ọna asopọ Colab duro ni iduroṣinṣin.
...
Ṣiṣan iṣẹ CI tun ṣe awọn faili READMEati awọn iwe ajako lati awoṣe ati awọn faili agbegbe, sọwedowo iwe ajako JSON, ṣayẹwo awọn abajade ofo, sọwedowo syntax Python ni awọn sẹẹli koodu, ṣayẹwo fun awọn aṣiri lairotẹlẹ ti o han gbangba, ati kuna nigbati awọn faili ti ipilẹṣẹ ko ṣe.

## Kini CI le ṣe idanwo

- READMEiran lati awọn faili agbegbe
- iran iwe ajako lati awoṣe ati awọn faili agbegbe
- ajako JSONwulo
- sofo ipaniyan awọn abajade
- Python sintasi ni awọn sẹẹli koodu
- kedere lairotẹlẹ asiri
- ti ipilẹṣẹ READMEati awọn faili ajako ti o baamu awọn orisun

Ọna ikọwe ni kikun nilo awọn API pato-Colab, awọn igbasilẹ awoṣe, wiwa GPU, ati awọn faili media ti a pese fun olumulo. Ṣe itọju ọna yẹn bi idanwo ẹfin Colab afọwọṣe lẹhin awọn sọwedowo-faili ti ipilẹṣẹ kọja.

## Iwe-aṣẹ

Ibi ipamọ yii's READMEmonomono, awoṣe iwe ajako, awọn faili agbegbe, awọn iwe ajako ti ipilẹṣẹ, ati awọn iwe afọwọkọ itọju jẹ idasilẹ labẹ iwe-aṣẹ MIT. Whisperawọn awoṣe ati awọn igbẹkẹle ẹni-kẹta ni iṣakoso nipasẹ awọn iwe-aṣẹ oniwun wọn.
